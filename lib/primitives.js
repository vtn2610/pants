 ...
 */
    ...
    function item() {
        return (istream) => {
            if (istream.isEmpty()) {
                ...
                return new Failure(istream.startpos, [new ItemError_1.ItemError()]);
            }
            else {
                    ...
                    switch (o1.tag) {
                        ...
                        default:
                            ...
                            switch (o3.tag) {
                                ...
                                case "success":
                                    let e = new SeqError_1.SeqError(o1.errors, minError2.modStream, minError2.edit, true, false);
                                    return new Failure(o1.error_pos, [e]);
                                //both p and q fail
                                default:
                                    let minError3 = argMin(o3.errors, e => e.edit);
                                    let e3 = new SeqError_1.SeqError(o3.errors, minError3.modStream, minError3.edit, true, true);
        ...
        let f = (x) => {
            return (char_class.indexOf(x.toString()) > -1)
                ...
                : (istream) => {
                    ...
                    return new Failure(istream.startpos - 1, [new SatError_1.SatError(2, char_class)]);
                };
        };
        let b = bind(item())(f);
    ...
    function letter() {
        ...
        return expect(parser)((e) => new LetterError_1.LetterError(e.causes, e.edit));
    }
    ...
    function digit() {
        ...
        return expect(parser)((e) => new DigitError_1.DigitError(e.causes, e.edit));
    }
    ...
    function many1(p) {
        return (istream) => {
            return seq(expect(p)((e) => e))(many(p))(tup => {
                let hd = tup["0"];
                let tl = tup["1"];
                tl.unshift(hd);
                return tl;
    ...
    function str(s) {
        ...
        return expect(_str(s))(e => new StringError_1.StringError([e], s));
    }
    Primitives.str = str;
    /**
    ...
    function between(popen) {
        return (pclose) => {
            return (p) => {
                let l = left(p)(expect(pclose)((e) => {
                    return new BetweenRightError_1.BetweenRightError(e.causes, e.edit);
                }));
                let r = right(expect(popen)((e) => new BetweenLeftError_1.BetweenLeftError(e.causes, e.edit)))(l);
                return r;
            };
        };
    }
    ...
    function ws1() {
        return (istream) => {
            let o = expect(many1(wschars))((e) => new WSError_1.WSError(e.causes, e.edit))(istream);
            switch (o.tag) {
                case "success":
                    return new Success(o.inputstream, CharStream.concat(o.result));
                case "failure":

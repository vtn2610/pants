...
(function (Primitives) {
    ...
    function char(c, edit = { sign: 2, char: c, pos: 0 }, strMode = false) {
        ...
        return failAppfun(sat([c]))(f => {
            let e = new CharError_1.CharError(f.errors, 0, c);
